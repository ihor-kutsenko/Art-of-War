export const blitz = [
  ...
  {
    title: 'blitz.weakestLink.name',
    imageUrl:
      'https://res.cloudinary.com/dsy8hantq/image/upload/v1727420360/weakest-link_kh8lpr.webp',
    buttonText: 'Medals',
    medals: [],
    info: 'blitz.weakestLink.info',
  },
  {
    title: 'blitz.wingsOfDefense.name',
    imageUrl:
  ...
  {
    title: 'blitz.zombieApocalypse.name',
    imageUrl:
